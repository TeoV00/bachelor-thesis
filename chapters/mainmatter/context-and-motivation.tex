...
come ad esempio il gioco \textit{Dumb Ways to Die} \cite{dumbwaytodie} (figura \ref{fig:dumbwaytodie}) promosso dalla Metro Trains Melbourne per promuovere la sicurezza ferroviaria specialmente ai più piccoli.
...
La Realtà Virtuale (in inglese Virtual Reality, VR) sostituisce l'ambiente circostante con uno che realmente esiste (es. simulazioni, viaggio su marte) o completamente virtuale (es. videogiochi, metaverso), isolando l'utente da tutte le interazioni sociali esterne.

Questa realtà prevede tipicamente l'uso di un visore VR per la generazione di un ambiente virtuale con l'ausilio di dispositivi come tute, guanti, maschere o cuffie per rendere più immersiva e realistica l'esperienza virtuale.
