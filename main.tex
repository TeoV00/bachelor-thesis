...
\begin{document}
    ...
    % ---------------------------------------------------------------------
    \mainmatter
    \input{./chapters/mainmatter/context-and-motivation.tex}
    \input{./chapters/mainmatter/design-and-tecnologies.tex}
    \input{./chapters/mainmatter/implementation.tex}

    \backmatter
    \input{./chapters/backmatter/conclusion.tex}
    \input{./chapters/backmatter/ringraziamenti.tex}
    % ---------------------------------------------------------------------
